...
func _process(_delta: float) -> void:
	if animated_sprite_2d.animation == "activate":
		if animated_sprite_2d.frame == 0:
			...
			animated_light_pixel_9.position = Vector2(-2, 7)
			animated_light_pixel_10.position = Vector2(-1, 7)
			animated_light_pixel_11.position = Vector2(0, 7)
			animated_light_pixel_12.position = Vector2(1, 7)
			animated_light_pixel_13.position = Vector2(-2, -8)
			animated_light_pixel_14.position = Vector2(-1, -8)
			animated_light_pixel_15.position = Vector2(0, -8)
			animated_light_pixel_16.position = Vector2(1, -8)
		...
		if animated_sprite_2d.frame == 0:
			...
			animated_light_pixel.position = Vector2(0, 0)
